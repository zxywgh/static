...
function ClientSideStrongPassword(p0,p1,p2){
	return (IsLongEnough(p0, "8") && SpansEnoughCharacterSets(p0, "3") && (!(IsCloseVariationOfAWordInDictionary(p0, "0.6", p1, p2))));
}

function ClientSideBestPassword(p0,p1,p2){
	return (IsLongEnough(p0, "14") && SpansEnoughCharacterSets(p0, "3") && (!(IsCloseVariationOfAWordInDictionary(p0, "0.6", p1, p2))));
}

function ClientSideMediumPassword(p0,p1,p2){
	return (IsLongEnough(p0, "8") && SpansEnoughCharacterSets(p0, "2") && (!(FoundInDictionary(p0, p1, p2))));
}

function ClientSideWeakPassword(p0,p1,p2){
	return (IsLongEnough(p0, "1") || (!(IsLongEnough(p0, "0"))));
}
